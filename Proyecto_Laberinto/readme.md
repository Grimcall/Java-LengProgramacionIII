La figura mostrada a continuación representa un laberinto, en el cual la posición de entrada se indica por la marca de inicio (I) y la salida que se indica por la marca de finalización (F).
